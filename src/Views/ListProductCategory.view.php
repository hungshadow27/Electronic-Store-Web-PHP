...
<div class="list-brand container">
    <div class="d-flex flex-wrap justify-content-start">
        <div class="p-1 border rounded-1 text-center m-1" style="width: 13%">
            <a href="#"><img src="https://img.hungmobile.vn/hungmobile-vn/2021/12/w150/logo-lenovo.jpg" alt="" /></a>
        </div>
        <div class="p-1 border rounded-1 text-center m-1" style="width: 13%">
            <a href="#"><img src="https://img.hungmobile.vn/hungmobile-vn/2021/12/w150/logo-lenovo.jpg" alt="" /></a>
        </div>
...
<div class="main-content my-3">
    <div class="container d-flex justify-content-center align-items-start">
        ...
        <div class="table-product border rounded shadow p-2 ms-2" style="width: 79%">
            ...
            <hr />
            <div class="list-product d-flex flex-wrap justify-content-center align-items-stretch">
                <div class="card position-relative mx-1 my-2 shadow" style="width: 24%">
                    ...
                    <div class="card-body">
                        ...
                        <div class="buy-btn text-center">
                            <a href="./detail.html" class="btn btn-danger my-1">Mua ngay</a>
                            <a href="#" class="btn btn-secondary my-1">Thêm vào giỏ hàng</a>
                        </div>
            ...
            <a href="#" class="btn btn-outline-primary text-center d-block mx-auto w-25 my-2">Xem thêm sản phẩm</a>
        </div>
    </div>
</div>
